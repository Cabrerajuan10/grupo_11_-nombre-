...
module.exports = {
    ...
    deleteImage : async (req,res) => {
        try {
            ...
            fs.existsSync(path.join(__dirname, '../../public/images/detailProduct/' +image.file)) ? fs.unlinkSync(path.join(__dirname, '../../public/images/detailProduct/' +image.file)) : null
